...
function FileMetadataContent({ fileId }: { fileId: string }) {
  ...
  // Debug logging
  console.log("FileMetadataContent:", { fileId, isLoading, error, fileMetadata });
        ...
        <div className="space-y-3">
          ...
          {fileMetadata.encryptionKeys.length > 0 && (
              <div className="space-y-2">
                ...
                {fileMetadata.encryptionKeys.map((encKey: any) => (
                  <div
                    key={encKey.id}
      ...
      {fileMetadata.sharedFiles.length > 0 && (
        <>
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              {fileMetadata.sharedFiles.map((sharedFile: any) => (
                <div
                  key={sharedFile.id}
                  className="rounded-lg border p-3 text-sm"
                >
